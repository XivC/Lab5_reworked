...
public abstract class InputManager {
     ...
     * @return
     */
    public ArrayList<String> getWords() {return this.wordBuffer;}

    /**
     * ернуть строковый буффер
     * @return
     */
    public String getString() {return this.stringBuffer;}

    /**
     * Вернуть символьный буффер
     * @return
     */
    public ArrayList<Character> getCharacter() {return this.charBuffer;}
